...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SplashScreenBlock".
 */
export interface SplashScreenBlock {
  tagLine?: string | null;
  enableLink?: boolean | null;
  link?: {
    type?: ('reference' | 'custom') | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SplashScreenBlock_select".
 */
export interface SplashScreenBlockSelect<T extends boolean = true> {
  tagLine?: T;
  enableLink?: T;
  link?:
    | T
