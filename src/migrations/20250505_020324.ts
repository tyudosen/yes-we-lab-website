...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_form_block_auth_action" AS ENUM('login', 'signUp');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_content_type" AS ENUM('richText', 'block');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_form_block_auth_action" AS ENUM('login', 'signUp');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_content_type" AS ENUM('richText', 'block');
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'user', 'editor');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_form_block" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"form_id" integer,
  	"is_auth_form" boolean DEFAULT false,
  	"auth_action" "enum_pages_blocks_form_block_auth_action",
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_columns" (
  	...
  	"content_type" "enum_pages_blocks_content_columns_content_type",
  	"rich_text" jsonb,
  	"enable_link" boolean,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_form_block" (
  	...
  	"form_id" integer,
  	"is_auth_form" boolean DEFAULT false,
  	"auth_action" "enum__pages_v_blocks_form_block_auth_action",
  	"enable_intro" boolean,
  	"intro_content" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_columns" (
  	...
  	"content_type" "enum__pages_v_blocks_content_columns_content_type",
  	"rich_text" jsonb,
  	"enable_link" boolean,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_form_block_auth_action";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_form_block_auth_action";
