...
export const enum_pages_blocks_form_block_auth_action = pgEnum(
  'enum_pages_blocks_form_block_auth_action',
  ['login', 'signUp'],
)
...
export const enum__pages_v_blocks_form_block_auth_action = pgEnum(
  'enum__pages_v_blocks_form_block_auth_action',
  ['login', 'signUp'],
)
...
export const enum_users_roles = pgEnum('enum_users_roles', ['admin', 'user', 'editor'])
...
export const pages_blocks_order_status_block = pgTable(
  'pages_blocks_order_status_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    test: integer('test_id').references(() => posts.id, {
      onDelete: 'set null',
    }),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_order_status_block_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_order_status_block_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_order_status_block_path_idx').on(columns._path),
    pages_blocks_order_status_block_test_idx: index('pages_blocks_order_status_block_test_idx').on(
      columns.test,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_order_status_block_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_content_columns = pgTable(
  'pages_blocks_content_columns',
  {
    ...
    contentType: enum_pages_blocks_content_columns_content_type('content_type'),
    richText: jsonb('rich_text'),
...
export const pages_blocks_form_block = pgTable(
  'pages_blocks_form_block',
  {
    ...
    isAuthForm: boolean('is_auth_form').default(false),
    authAction: enum_pages_blocks_form_block_auth_action('auth_action'),
...
export const _pages_v_blocks_order_status_block = pgTable(
  '_pages_v_blocks_order_status_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_order_status_block_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_order_status_block_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_order_status_block_path_idx').on(columns._path),
    _pages_v_blocks_order_status_block_test_idx: index(
      '_pages_v_blocks_order_status_block_test_idx',
    ).on(columns.test),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_order_status_block_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_content_columns = pgTable(
  '_pages_v_blocks_content_columns',
  {
    ...
    contentType: enum__pages_v_blocks_content_columns_content_type('content_type'),
    richText: jsonb('rich_text'),
    enableLink: boolean('enable_link'),
...
export const _pages_v_blocks_form_block = pgTable(
  '_pages_v_blocks_form_block',
  {
    ...
    isAuthForm: boolean('is_auth_form').default(false),
    authAction: enum__pages_v_blocks_form_block_auth_action('auth_action'),
    enableIntro: boolean('enable_intro'),
    introContent: jsonb('intro_content'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
...
export const forms_blocks_password = pgTable(
  'forms_blocks_password',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('forms_blocks_password_order_idx').on(columns._order),
    _parentIDIdx: index('forms_blocks_password_parent_id_idx').on(columns._parentID),
    _pathIdx: index('forms_blocks_password_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [forms.id],
      name: 'forms_blocks_password_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const relations_pages_blocks_order_status_block = relations(
  pages_blocks_order_status_block,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_order_status_block._parentID],
      references: [pages.id],
      relationName: '_blocks_orderStatusBlock',
    }),
    test: one(posts, {
      fields: [pages_blocks_order_status_block.test],
      references: [posts.id],
      relationName: 'test',
    }),
  }),
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_orderStatusBlock: many(pages_blocks_order_status_block, {
    relationName: '_blocks_orderStatusBlock',
  }),
...
export const relations__pages_v_blocks_order_status_block = relations(
  _pages_v_blocks_order_status_block,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_order_status_block._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_orderStatusBlock',
    }),
    test: one(posts, {
      fields: [_pages_v_blocks_order_status_block.test],
      references: [posts.id],
      relationName: 'test',
    }),
  }),
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_orderStatusBlock: many(_pages_v_blocks_order_status_block, {
    relationName: '_blocks_orderStatusBlock',
  }),
...
export const relations_forms_blocks_password = relations(forms_blocks_password, ({ one }) => ({
  _parentID: one(forms, {
    fields: [forms_blocks_password._parentID],
    references: [forms.id],
    relationName: '_blocks_password',
  }),
}))
...
export const relations_forms = relations(forms, ({ many }) => ({
  ...
  _blocks_password: many(forms_blocks_password, {
    relationName: '_blocks_password',
  }),
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_form_block_auth_action: typeof enum_pages_blocks_form_block_auth_action
  ...
  enum__pages_v_blocks_form_block_auth_action: typeof enum__pages_v_blocks_form_block_auth_action
  ...
  pages_blocks_order_status_block: typeof pages_blocks_order_status_block
  ...
  _pages_v_blocks_order_status_block: typeof _pages_v_blocks_order_status_block
  ...
  forms_blocks_password: typeof forms_blocks_password
  ...
  relations_pages_blocks_order_status_block: typeof relations_pages_blocks_order_status_block
  ...
  relations__pages_v_blocks_order_status_block: typeof relations__pages_v_blocks_order_status_block
  ...
  relations_forms_blocks_password: typeof relations_forms_blocks_password
